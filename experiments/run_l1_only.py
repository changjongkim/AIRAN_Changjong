"""
L1 Measurement Only — no AI worker management.
AI stress is launched externally by the shell script.
"""
import os
import sys
import json
...
def main():
    ...
    with open(out, "w") as f:
        json.dump({"label": label, "stats": s, "miss_1ms": miss, "raw": trk.latencies}, f, indent=2)
