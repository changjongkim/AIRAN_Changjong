...
#SBATCH --exclusive
#SBATCH -J g40_intf
#SBATCH -o /pscratch/sd/s/sgkim/kcj/AI-RAN/jobs/g40_intf_%j.out
#SBATCH -e /pscratch/sd/s/sgkim/kcj/AI-RAN/jobs/g40_intf_%j.err
...
echo "============================================================"
echo "40GB Interference: ${TX}T${RX}R × ${CELLS}cells"
echo "============================================================"
