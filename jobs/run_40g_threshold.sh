...
#SBATCH --exclusive
#SBATCH -J g40_thresh
#SBATCH -o /pscratch/sd/s/sgkim/kcj/AI-RAN/jobs/g40_thresh_%j.out
#SBATCH -e /pscratch/sd/s/sgkim/kcj/AI-RAN/jobs/g40_thresh_%j.err
...
echo "============================================================"
echo "40GB Threshold: ${TX}T${RX}R × ${CELLS}cells"
echo "============================================================"
...
start_mps baseline
shifter --image=$IMAGE python3 $L1 g40_thresh_baseline $TX $RX $CELLS $MCS
stop_mps; echo ""
...
start_mps final
shifter --image=$IMAGE python3 $L1 g40_thresh_baseline_final $TX $RX $CELLS $MCS
stop_mps
